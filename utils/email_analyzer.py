...
class EmailThreadAnalyzer:
    ...
    def _parse_gmail_messages(
        self, gmail_messages: List[Dict], user_email: str
    ) -> List[EmailMessage]:
    ...
    def _extract_thread_metadata(self, messages: List[EmailMessage]) -> Dict[str, Any]:
        ...
        return {
            ...
            "conversation_span_days": self._calculate_span_days(
...
def analyze_fundraising_thread(
    gmail_client: GmailClient,
    mailbox: str,
    thread_id: str,
    user_email: str,
    ...
    return analyzer.analyze_thread_from_gmail(
        gmail_client, mailbox, thread_id, user_email, company_context
    )
